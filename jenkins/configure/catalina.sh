...
CATALINA_HOME=/data/apps/$apps_name
CATALINA_BASE=/data/apps/$apps_name
CATALINA_PID=/var/run/${apps_name}.pid
export JENKINS_HOME=/data/apps/jenkins/jenkins-data
# -----------------------------------------------------------------------------
JAVA_OPTS='-Xms1024m -Xmx1024m -XX:NewSize=128m -XX:MaxNewSize=256m  -Duser.timezone=GMT+08 -Dfile.encoding=UTF-8 -Djava.security.egd=file:/dev/./urandom'
#CATALINA_OPTS=" -Dcom.sun.management.jmxremote \
    #                -Djava.rmi.server.hostname=172.19.0.3 \
    #                -Dcom.sun.management.jmxremote.port=3244 \
